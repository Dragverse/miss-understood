-- Dragverse Livestreaming Database Schema (Safe Version)
-- This version safely creates or replaces existing objects
...
DO $$
BEGIN
  RAISE NOTICE '✅ Livestream database migration completed successfully!';
  RAISE NOTICE '📊 Created/verified tables: streams, stream_recordings';
  RAISE NOTICE '🔒 Row Level Security policies configured';
  RAISE NOTICE '⚡ Indexes created for optimal performance';
  RAISE NOTICE '';
  RAISE NOTICE '🎥 You can now:';
  RAISE NOTICE '   - Create livestreams from /live page';
  RAISE NOTICE '   - View active streams on creator profiles';
  RAISE NOTICE '   - Manage recordings from dashboard';
END $$;
