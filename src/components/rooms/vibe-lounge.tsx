...
export function VibeLounge() {
  ...
  if (!isPanelOpen && activeRoom) {
    return (
      <div className="hidden md:block fixed bottom-24 right-4 z-[60] w-72 bg-[#1a0b2e] border border-[#EB83EA]/40 rounded-2xl shadow-2xl shadow-[#EB83EA]/10 overflow-hidden">
  ...
  return (
    <>
      ...
      <div className="hidden md:block fixed inset-0 z-[54] bg-black/40 lg:hidden" onClick={closePanel} />

      {/* Panel — desktop only sidebar */}
      <div className="hidden md:flex fixed top-16 left-0 sm:left-auto right-0 bottom-0 z-[55] w-full sm:w-80 bg-[#0f071a] border-l border-[#2f2942] flex-col">
        {/* Header */}
