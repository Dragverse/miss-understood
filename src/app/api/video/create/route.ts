...
export async function POST(request: NextRequest) {
  try {
    ...
    // Use default for null, undefined, OR empty string
    const finalThumbnail = (thumbnail && thumbnail.trim() !== '') ? thumbnail : DEFAULT_THUMBNAIL;
    ...
    try {
      ...
      const videoData = {
        ...
        likes: 0,
        createdAt: new Date(),
        playback_url: playbackUrl || `https://vod-cdn.lp-playback.studio/raw/jxf4iblf6wlsyor6526t4tcmtmqa/catalyst-vod-com/hls/${playbackId}/index.m3u8`,
        livepeer_asset_id: livepeerAssetId,
        content_type: contentType,
        category,
        tags: tagsArray,
