      ...
      headers: [
        ...
        // Content Security Policy for Privy embedded wallets + Cloudflare Turnstile
        {
          ...
          value: [
            ...
            "connect-src 'self' https://auth.privy.io https://*.privy.io https://*.walletconnect.com https://*.walletconnect.org https://*.infura.io https://*.alchemy.com wss://*.walletconnect.com wss://*.walletconnect.org https://livepeercdn.studio https://livepeer.studio https://*.livepeer.studio https://*.lp-playback.studio wss://*.lp-playback.studio https://playback.livepeer.studio https://origin.livepeer.com https://storage.googleapis.com https://*.supabase.co wss://*.supabase.co https://challenges.cloudflare.com https://www.youtube.com https://*.youtube.com https://*.googlevideo.com https://bsky.social https://*.bsky.social https://bsky.app https://*.bsky.app https://mainnet.base.org https://lvpr.tv https://*.lvpr.tv",
